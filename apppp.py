...
html, body { margin:0; padding:0; font-family:'Cairo',sans-serif; width:100%; height:100%; background: linear-gradient(-45deg, #1b1b2f, #4e54c8, #00c6ff, #0072ff); background-size: 400% 400%; animation: gradientMove 25s ease infinite; color:white; display:flex; flex-direction:column; justify-content:center; align-items:center;}
...
.buttons a button{padding:25px 50px;font-size:22px;font-weight:bold;border:none;border-radius:30px;cursor:pointer;background: linear-gradient(90deg,#00ffff,#0072ff);color:#1b1b2f;transition:0.3s;}
.buttons a button:hover{transform:scale(1.08);}
.container{max-width:900px;width:95%;margin:30px auto;padding:30px;background: rgba(0,0,0,0.6);border-radius:25px;display:flex;flex-direction:column;align-items:center;}
h2.result-title{text-align:center;color:#00ffff;margin-bottom:30px;font-size:28px;}
.cards{display:flex;flex-wrap:wrap;gap:20px;justify-content:center;}
.card{background: rgba(255,255,255,0.05);padding:20px;border-radius:20px;width: 250px;text-align:center;transition:0.3s;}
.card:hover{transform: translateY(-6px);}
.card h3{margin-bottom:15px;color:#ffd700;}
.card input{width:40%;padding:10px;margin:5px 3%;border-radius:12px;border:none;background: rgba(255,255,255,0.12);color:#fff;font-weight:bold;text-align:center;transition:0.25s;}
.card input:focus{background: rgba(0,255,255,0.2);transform: scale(1.05);outline:none;}
button.calc{display:block;margin:25px auto 0 auto;padding:14px 28px;border:none;border-radius:22px;font-weight:bold;background: linear-gradient(90deg,#00ffff,#0072ff);color:#1b1b2f;font-size:16px;cursor:pointer;transition:0.3s;}
button.calc:hover{transform:scale(1.08);}
.result{margin-top:28px;font-size:28px;font-weight:bold;text-align:center;padding:18px;border-radius:20px;background: rgba(255,255,255,0.07);}
a.reset-btn, a.home-btn{display:inline-block;margin:10px 5px 0 5px;padding:14px 28px;background: linear-gradient(90deg,#0072ff,#00ffff);color:#1b1b2f;border-radius:18px;font-weight:bold;text-decoration:none;transition:0.3s;}
...
@media(max-width:768px){.cards { flex-direction: column; align-items:center;}.card { width:90%; }.card input { width:45%; }.buttons a button { width:90%; padding:20px 0; }}
</style>
'''
...
if __name__ == "__main__":
    app.run(host="0.0.0.0", port=5000)<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
''' + style + '''
</head>
<body>
<header>
