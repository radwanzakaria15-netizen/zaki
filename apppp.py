...
<div class="card"><h3>النحو</h3>
  <input type="number" name="tdnaho" placeholder="TD" min="0" max="20" required>
  <input type="number" name="examnaho" placeholder="Exam" min="0" max="20" required>
</div>
<div class="card"><h3>الصرف</h3>
  <input type="number" name="tdsrf" placeholder="TD" min="0" max="20" required>
  <input type="number" name="examsrf" placeholder="Exam" min="0" max="20" required>
</div>
<div class="card"><h3>الأدب</h3>
  <input type="number" name="tdadab" placeholder="TD" min="0" max="20" required>
  <input type="number" name="examadab" placeholder="Exam" min="0" max="20" required>
</div>
<div class="card"><h3>الرياضيات</h3>
  <input type="number" name="tdm" placeholder="TD" min="0" max="20" required>
  <input type="number" name="examm" placeholder="Exam" min="0" max="20" required>
</div>
<div class="card"><h3>الفيزياء</h3>
  <input type="number" name="tdf" placeholder="TD" min="0" max="20" required>
  <input type="number" name="examf" placeholder="Exam" min="0" max="20" required>
</div>
<div class="card"><h3>الكيمياء</h3>
  <input type="number" name="tdc" placeholder="TD" min="0" max="20" required>
  <input type="number" name="examc" placeholder="Exam" min="0" max="20" required>
</div>
<div class="card"><h3>الشريعة</h3>
  <input type="number" name="examchari3a" placeholder="Exam" min="0" max="20" required>
</div>
<div class="card"><h3>{{tech_name}}</h3>
  <input type="number" name="tdtech" placeholder="TD" min="0" max="20" required>
  <input type="number" name="examtech" placeholder="Exam" min="0" max="20" required>
</div>
<div class="card"><h3>مواد أخرى</h3>
  <input type="number" name="b" placeholder="البلاغة" min="0" max="20" required>
  <input type="number" name="e" placeholder="الانجليزية" min="0" max="20" required>
  <input type="number" name="i" placeholder="{{other_name}}" min="0" max="20" required>
  <input type="number" name="y" placeholder="فنيات الكتابة" min="0" max="20" required>
</div>
</div>
...
def s2():
    ...
    if request.method=="POST":
        ...
        if mo3adal >= 10:
            ...
            msg="لا تقلق، راك خادم في السداسي الاول أو استعد للاستدراكي"
...
app.run(host="0.0.0.0", port=5000)header h1{
    font-size:60px;
    color:#00ffff;
    margin-bottom:10px;
}
...
<head>
<meta charset="UTF-8">
<title>حساب معدل (ملمح ابتدائي)</title>
''' + style + '''
</head>
<body>
<header>
...
<footer>
<a href="https://t.me/zakariazakii" target="_blank"><i class="fab fa-telegram"></i></a>
</footer>
</body>
</html>
'''
...
app.run(host="0.0.0.0", port=5000)    font-size:60px;
    color:#00ffff;
    margin-bottom:10px;
}
